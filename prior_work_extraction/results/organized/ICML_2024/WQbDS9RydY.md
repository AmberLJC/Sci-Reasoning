...
- *Connection:* Established that over-parameterized networks can perfectly fit random labels, motivating the need for per-sample measures of memorization that the present paper seeks to provide via curvature.

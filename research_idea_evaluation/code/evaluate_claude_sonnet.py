#!/usr/bin/env python3
"""
Research Idea Generation Evaluation - Claude Sonnet 4.5
Uses Exa AI for paper retrieval, Claude for idea generation and judging
"""
...
# Pricing for Claude Sonnet 4.5 (estimate - adjust as needed)
...
def save_results(results, total_input_tokens, total_output_tokens, start_time, interim=False):
    ...
    output_data = {
        "summary": {"model": "claude-sonnet-4.5", "k": 10, "crawl_method": "exa_ai",
    ...
    output_path = f"projects/research_idea_evaluation/results/evaluation_results_claude_sonnet{suffix}.json"
...
def main():
    print("="*70)
    print("Research Idea Generation - Claude Sonnet 4.5")
